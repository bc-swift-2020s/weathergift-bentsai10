...
extension LocationDetailViewController: CLLocationManagerDelegate{
    ...
    func getLocation(){
        //creating clllocationmanager will automatically check authorization
    ...
    func handleAuthorizationStatus(status: CLAuthorizationStatus){
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select settings below to authorize location services")
        case .authorizedAlways, .authorizedWhenInUse:
            locationManager.requestLocation()
        @unknown default:
            print("ERROR: DEVELOPER ALERT")
        }
    }
    ...
    func showAlertToPrivacySettings(title: String, message: String){
        ...
        guard let settingsURL = URL(string: UIApplication.openSettingsURLString) else{
            print("Error: Something went wrong opening settings")
            return
        }
